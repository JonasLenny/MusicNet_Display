...
function appendDevSettings(env) {
    ...
    const outputName   = `assets/js/${projectConfig.project.bundleName}.js`
    ...
    const htmlTemplate = `${rootDir}/src/data/templates/index.template.html`
    ...
    let devSettings    = {
        ...
        devServer: {
            ...
            contentBase        : `${rootDir}/${buildPath}`,
            host               : serverPath || 'localhost',
            port               : serverPort,
            hot                : true,
        },
        plugins: [
